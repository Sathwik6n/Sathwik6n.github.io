...
while True:
    ...
    if choice == "1":
        ...
        print("Invalid Choice. Try Again.")[Digital Literacy Improvement Program.py](https://github.com/user-attachments/files/28659705/Digital.Literacy.Improvement.Program.py)
